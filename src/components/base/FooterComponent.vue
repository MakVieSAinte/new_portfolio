        ...
        <div class="flex flex-wrap justify-between items-center gap-2 md:pb-1 max-md:pb-5">
          ...
          <ul class="flex flex-wrap items-center !list-none">
            <li
              ...
              <a href="#">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" class="bi bi-github max-md:text-md md:text-sm text-gray-500 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-white transition-colors duration-150" xmlns="http://www.w3.org/2000/svg">
