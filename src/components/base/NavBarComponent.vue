<template>
  <div>
    ...
    <div class="fixed md:top-10 max-md:bottom-5 inset-x-0 text-center z-50">
      <div
        class="inline-block backdrop-blur-sm md:bg-white/50 max-md:bg-white/60 rounded-full py-3 px-4 md:dark:bg-neutral-800/50 max-md:dark:bg-neutral-800/60 border border-neutral-200 dark:border-neutral-600 shadow-md shadow-neutral-600/5 z-50">
        <div class="flex items-center gap-x-1">
          ...
          <a href="http://">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
              class="bi bi-linkedin max-md:text-md md:text-sm text-neutral-500 dark:text-neutral-400 dark:hover:text-white hover:text-neutral-900 transition-colors duration-150"
              viewBox="0 0 16 16">
              <path
