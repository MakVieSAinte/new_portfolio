      ...
      <div class="max-w-[85rem] px-2 py-10 sm:px-4 lg:px-0 lg:py-14 mx-auto">
        ...
        <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div @mouseenter="playVideo" @mouseleave="stopVideo"
            ...
            <div class="h-52 bg-bleu-400 flex flex-col justify-center items-center rounded-t-xl">
              ...
              <img v-else src="@/assets/images/projets/nature-moi.png" class="size-28 w-full h-full object-cover"
                alt="projet">
            </div>
            <div class="p-4 md:p-6">
              <span class="flex mb-1 text-xs font-semibold uppercase text-blue-600 dark:text-blue-500">
                <!-- HTML -->
                <svg class="shrink-0 me-1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="27" height="27"
                  viewBox="0 0 48 48">
              ...
              <p class="mt-3 text-gray-500 dark:text-neutral-300">
                Nature Émoi est une boutique en ligne de plantes, développée avec HTML et CSS.
              </p>
            </div>
            <div
          ...
          <div
            ...
            <div class="h-52 flex flex-col justify-center items-center bg-amber-500 rounded-t-xl">
              <svg class="size-28" width="56" height="180" viewBox="0 0 56 56" fill="none"
