    ...
    <div class="max-w-[85rem] px-2 py-0 sm:px-4 lg:px-0 lg:py-4 mx-auto">
      ...
      <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
        ...
        >
          ...
          >
            <span
              class="w-[8px] h-[8px] border-neutral-100 dark:bg-neutral-700 rounded-full group-hover:bg-red-600 transition-all duration-100"
            ></span>
            <span
              class="w-[8px] h-[8px] border-neutral-100 dark:bg-neutral-700 rounded-full group-hover:bg-yellow-600 transition-all duration-100"
            ></span>
            <span
              class="w-[8px] h-[8px] border-neutral-100 dark:bg-neutral-700 rounded-full group-hover:bg-green-600 transition-all duration-100"
            ></span>
          </div>
          ...
          >
            <video
              v-if="isHovering"
              ref="videoPlayer"
              src="@/assets/videos/nature-moi.mp4"
            ...
            <img
              v-else
              src="@/assets/images/projets/nature-moi.png"
              alt="image projet"
          ...
          >
            ...
            >
              ...
              >
                <a
                  href="https://nature-emoi.vercel.app/"
                  target="_blank"
                ...
                >
                  <svg
                    ...
                    stroke-width="1.5"
                    stroke="currentColor"
                    class="size-3 group-hover:-rotate-45 transition-all duration-[1s]"
                  >
                    <path
