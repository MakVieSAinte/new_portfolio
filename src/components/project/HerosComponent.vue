  ...
  <div>
    ...
    <div class="mt-8 mb-12">
      ...
      >
        ...
        >
          <span
            class="flex items-center justify-center gap-[6px] font-medium !text-[15px] text-gray-800 dark:text-neutral-200 dark:group-hover:dark:text-neutral-100 group-hover:dark:text-gray-900 leading-none"
          >
            <svg
        ...
        I'm proud of, showcasing my process from concept to execution.
      </p>
    </div>
  </div>
</template>
