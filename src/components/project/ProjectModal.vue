<template>
  <teleport to="body">
    <transition name="fade">
      <div
        v-if="isOpen && project"
        class="fixed inset-0 z-50 flex items-center justify-center p-4 duration-150"
      >
        <div
        ...
        >
          ...
          >
            <div class="w-full">
              <div
                class="flex flex-col max-md:gap-2 md:flex-row items-start md:items-center gap-5 mb-0 pt-0 md:pt-2"
              >
                <h3
          ...
          <!-- Content -->
          <div
            class="p-3 md:p-5 pt-2 md:pt-3 overflow-y-auto custom-scrollbar flex-grow"
          >
            <div>
