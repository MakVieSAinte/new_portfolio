        ...
        <div
          ...
          <div>
            <div class="flex items-center gap-5 mb-0 pt-2">
              <h3 class="text-xl font-bold text-neutral-900 dark:text-white" :title="project.title">
                {{ truncateText(project.title, 20) }}
              </h3>
              <!-- year + category -->
              <div class="pt-1 text-xs text-neutral-500 dark:text-neutral-400 flex flex-wrap gap-x-1 gap-y-1">
