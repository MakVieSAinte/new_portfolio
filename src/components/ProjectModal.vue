        ...
        <div
          ...
          <div>
            <div class="flex items-center gap-5 mb-0 pt-2">
              ...
              <!-- year + category -->
              <div class="pt-1 text-xs text-neutral-600 dark:text-neutral-400 flex flex-wrap gap-x-1 gap-y-1">
        ...
        <div class="p-5 pt-3 overflow-y-auto custom-scrollbar flex-grow">
          ...
          <div class="mt-4 flex flex-col gap-4">
            <div>
              ...
              <p class="text-md text-neutral-600 dark:text-neutral-400 mt-0 italic">
