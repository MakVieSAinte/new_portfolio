  ...
  <div>
    ...
    <div class="max-w-full py-0 sm:px-0 lg:px-0 lg:py-1 mt-6 sm:mt-0 mx-auto">
      ...
      <p class="text-md font-light text-gray-800 dark:text-neutral-400">
        Ces outils sont pour moi bien plus que des langages ou frameworks : ce
        sont des partenaires pour transformer des idées en expériences concrètes
        et engageantes.
      </p>
      ...
      >
        ...
        >
         <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" id="Playwright--Streamline-Svg-Logos" height="40" width="40">
  <desc>
