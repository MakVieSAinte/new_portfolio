  ...
  <div>
    ...
    <div class="max-w-full py-0 sm:px-0 lg:px-0 lg:py-1 mt-6 sm:mt-0 mx-auto">
      ...
      <div class="my-6 mt-8 md:my-6 grid grid-cols-5 sm:flex sm:justify-start sm:flex-row gap-6 sm:gap-x-4 lg:gap-x-4">
        ...
        <!-- Prisma -->
        <a class="box shrink-0 transition hover:-translate-y-2" href="https://prisma.io/">

          <svg class="md:size-10 size-12 mx-auto sm:mx-0 dark:text-slate-200" viewBox="0 0 256 310" width="25"
        ...
        <a class="box shrink-0 transition hover:-translate-y-4" href="https://gsap.com/">
          <svg xmlns="http://www.w3.org/2000/svg" class="md:size-12 size-16 mx-auto sm:mx-0" width="200" fill="none"
            viewBox="0 0 82 30">
            <path fill="#0ae448"
        ...
        <!-- PLAYWRIGHT -->
        <a class="box shrink-0 transition hover:-translate-y-4 pt-1" href="https://playwright.dev/">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" id="Playwright--Streamline-Svg-Logos"
            height="40" width="40">
            <path fill="#2d4552"
