  ...
  <div>
    ...
    <div class="my-10 sm:my-14">
      ...
      <p class="text-md font-light text-gray-800 dark:text-neutral-400">
        ...
        <a
          href="https://cal.com/makviesainte/appel-decouverte"
          target="_blank"
          class="underline text-primary hover:text-primary dark:hover:text-white"
          >{{ texts?.contact?.description2 }}</a
        >
      </p>
      ...
      <form action="https://formspree.io/f/mldlrryo" method="POST" class="mt-8">
        ...
        >
          ...
          <!-- Séparateur -->
          <div
            class="hidden sm:block h-8 w-px bg-gray-200 dark:bg-neutral-700 mx-2"
          ></div>
          ...
          <input
            type="hidden"
            name="_subject"
            :value="texts?.contact?.hiddenSubject"
          />
