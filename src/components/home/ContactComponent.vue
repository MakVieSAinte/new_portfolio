  ...
  <div>
    ...
    <div class="my-10 sm:my-14">
      ...
      <p class="text-md font-light text-gray-800 dark:text-neutral-400">
        Une idée, un projet, une opportunité professionnelle ou simplement une
        question ? Laissez-moi votre e-mail et je vous recontacterai rapidement.
      </p>
      ...
      <form action="https://formspree.io/f/mldlrryo" method="POST" class="mt-8">
        ...
        >
          ...
          <input
            type="hidden"
            name="_subject"
            value="MakVieSAinte un nouveau client 😁"
          />
