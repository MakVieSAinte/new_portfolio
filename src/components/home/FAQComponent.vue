              ...
              <div id="hs-basic-active-bordered-collapse-one"
                ...
                <div class="pb-4 px-5">
                  <p class="text-gray-800 dark:text-neutral-400 leading-snug">
                    ...
                    <em>{{ texts?.faq?.qns?.technologies?.a2 }}</em>
                  </p>
                </div>
              </div>
            </div>
              ...
              <div id="hs-basic-active-bordered-collapse-three"
                ...
                <div class="pb-4 px-5">
                  <p class="text-gray-800 dark:text-neutral-400 leading-snug">
                    ...
                    <em>{{ texts?.faq?.qns?.process?.a2 }}</em>
                  </p>
                </div>
              </div>
            </div>
              ...
              <div id="hs-basic-active-bordered-collapse-three"
                ...
                <div class="pb-4 px-5">
                  <p class="text-gray-800 dark:text-neutral-400 leading-snug">
                    ...
                    <em>{{ texts?.faq?.qns?.testsBeforeDelivery?.a2 }}</em>
                  </p>
                </div>
              </div>
            </div>
              ...
              <div id="hs-basic-active-bordered-collapse-two"
                ...
                <div class="pb-4 px-5">
                  <p class="text-gray-800 dark:text-neutral-400 leading-snug">
                    ...
                    <em>{{ texts?.faq?.qns?.priceFix?.a2 }}</em>
                  </p>
                </div>
              </div>
            </div>
