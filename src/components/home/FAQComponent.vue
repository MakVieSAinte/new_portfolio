          ...
          <div class="hs-accordion-group flex flex-col gap-3">
              ...
              <div id="hs-basic-active-bordered-collapse-two"
                ...
                <div class="pb-4 px-5">
                  <p class="text-gray-800 dark:text-neutral-400 leading-snug">
                    Je développe des sites web interactifs, des applications front-end et back-end, ainsi que des
                    solutions full-stack complètes, <em>adaptées aux besoins de mes clients.</em>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <button
                ...
                Quels langages et technologies maîtrises-tu ?
                <svg class="hs-accordion-active:hidden block size-3.5" xmlns="http://www.w3.org/2000/svg" width="24"
                  height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                  stroke-linecap="round" stroke-linejoin="round">
                  <path d="M5 12h14"></path>
              ...
              <div id="hs-basic-active-bordered-collapse-one"
                ...
                <div class="pb-4 px-5">
                  <p class="text-gray-800 dark:text-neutral-400 leading-snug">
                    Je travaille principalement avec JavaScript, TypeScript, Vue.js, React, Node.js, MongoDB,
                    TailwindCSS et Git, <em>tout en restant ouvert à explorer de nouvelles technologies selon le
                      projet.</em>
                  </p>
                </div>
              </div>
            ...
            <div
              ...
              <button
                ...
                Comment se déroule ton processus de travail ?
                <svg class="hs-accordion-active:hidden block size-3.5" xmlns="http://www.w3.org/2000/svg" width="24"
                  height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                  stroke-linecap="round" stroke-linejoin="round">
                  <path d="M5 12h14"></path>
              ...
              <div id="hs-basic-active-bordered-collapse-three"
                ...
                <div class="pb-4 px-5">
                  <p class="text-gray-800 dark:text-neutral-400 leading-snug">
                    Mon processus comprend cinq étapes : découverte des besoins, conception, développement, revue et
                    feedback, <em>puis livraison et support si nécessaire.</em>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <button
                ...
                Fais-tu des tests avant la livraison ?
                <svg class="hs-accordion-active:hidden block size-3.5" xmlns="http://www.w3.org/2000/svg" width="24"
                  height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                  stroke-linecap="round" stroke-linejoin="round">
                  <path d="M5 12h14"></path>
              ...
              <div id="hs-basic-active-bordered-collapse-three"
                ...
                <div class="pb-4 px-5">
                  <p class="text-gray-800 dark:text-neutral-400 leading-snug">
                    Oui, je teste toutes les fonctionnalités et l’expérience utilisateur pour garantir <em>performance
                      et fiabilité.</em>
                  </p>
                </div>
              </div>
          ...
          <div class="hs-accordion-group flex flex-col gap-3">
            ...
            <div
              ...
              <button
                class="hs-accordion-toggle hs-accordion-active:text-blue-600 inline-flex justify-between items-center gap-x-3 w-full font-semibold text-start text-gray-900 py-4 px-5 hover:text-gray-900 disabled:opacity-50 disabled:pointer-events-none dark:hs-accordion-active:text-blue-500 dark:text-white dark:hover:text-slate-100 dark:focus:outline-hidden dark:focus:text-neutral-400"
                aria-expanded="false" aria-controls="hs-basic-active-bordered-collapse-two">
                Comment fixes-tu le prix d’un projet ?
                <svg class="hs-accordion-active:hidden block size-3.5" xmlns="http://www.w3.org/2000/svg" width="24"
                  height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                  stroke-linecap="round" stroke-linejoin="round">
                  <path d="M5 12h14"></path>
              ...
              <div id="hs-basic-active-bordered-collapse-two"
                ...
                <div class="pb-4 px-5">
                  <p class="text-gray-800 dark:text-neutral-400 leading-snug">
                    Le prix dépend de la complexité, du temps estimé et des fonctionnalités demandées. <em>Je fournis
                      toujours un devis détaillé avant de commencer.</em>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <button
                class="hs-accordion-toggle hs-accordion-active:text-blue-600 inline-flex justify-between items-center gap-x-3 w-full font-semibold text-start text-gray-900 py-4 px-5 hover:text-gray-900 disabled:opacity-50 disabled:pointer-events-none dark:hs-accordion-active:text-blue-500 dark:text-white dark:hover:text-neutral-400 dark:focus:outline-hidden dark:focus:text-neutral-400"
                aria-expanded="false" aria-controls="hs-basic-active-bordered-collapse-one">
                Est-ce que tu travailles au tarif horaire ou au forfait ?
                <svg class="hs-accordion-active:hidden block size-3.5" xmlns="http://www.w3.org/2000/svg" width="24"
                  height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                  stroke-linecap="round" stroke-linejoin="round">
                  <path d="M5 12h14"></path>
              ...
              <div id="hs-basic-active-bordered-collapse-one"
                ...
                <div class="pb-4 px-5">
                  <p class="text-gray-800 dark:text-neutral-400 leading-snug">
                    <em>Je peux m’adapter aux deux :</em> forfait pour un projet complet ou tarif horaire pour des
                    missions ponctuelles ou des ajustements.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <button
                class="hs-accordion-toggle hs-accordion-active:text-blue-600 inline-flex justify-between items-center gap-x-3 w-full font-semibold text-start text-gray-900 py-4 px-5 hover:text-gray-900 disabled:opacity-50 disabled:pointer-events-none dark:hs-accordion-active:text-blue-500 dark:text-white dark:hover:text-neutral-400 dark:focus:outline-hidden dark:focus:text-neutral-400"
                aria-expanded="false" aria-controls="hs-basic-active-bordered-collapse-three">
                Quels sont tes délais moyens de réalisation ?
                <svg class="hs-accordion-active:hidden block size-3.5" xmlns="http://www.w3.org/2000/svg" width="24"
                  height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                  stroke-linecap="round" stroke-linejoin="round">
                  <path d="M5 12h14"></path>
              ...
              <div id="hs-basic-active-bordered-collapse-three"
                ...
                <div class="pb-4 px-5">
                  <p class="text-gray-800 dark:text-neutral-400 leading-snug">
                    Les délais dépendent de la complexité du projet. En général, un site simple <em>peut être livré en 2
                      à 4 semaines</em>, tandis qu’une application complète <em>nécessite davantage de temps.</em>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div id="hs-basic-active-bordered-collapse-three"
                ...
                <div class="pb-4 px-5">
                  <p class="text-gray-800 dark:text-neutral-400 leading-snug">
                    Je communique immédiatement sur tout retard et propose des solutions pour respecter vos priorités
          ...
          <div class="hs-accordion-group flex flex-col gap-3">
            ...
            <div
              ...
              <div id="hs-basic-active-bordered-collapse-two"
                ...
                <div class="pb-4 px-5">
                  <p class="text-gray-800 dark:text-neutral-400 leading-snug">
                    <em>Je suis MakVieSainte, software developer et web designer.</em> Passionné par le code depuis
                    plusieurs années, j’ai commencé à programmer au lycée avant de poursuivre mes études à l’université.
                    Dès ma deuxième année universitaire, j’ai effectué un stage qui s’est conclu la même année par un
                    contrat à durée déterminée (CDD). Cette expérience m’a permis de renforcer mes compétences et de
                    confirmer mon engagement dans le domaine du développement web.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <button
                class="hs-accordion-toggle hs-accordion-active:text-blue-600 inline-flex justify-between items-center gap-x-3 w-full font-semibold text-start text-gray-900 py-4 px-5 hover:text-gray-900 disabled:opacity-50 disabled:pointer-events-none dark:hs-accordion-active:text-blue-500 dark:text-white dark:hover:text-neutral-400 dark:focus:outline-hidden dark:focus:text-neutral-400"
                aria-expanded="false" aria-controls="hs-basic-active-bordered-collapse-one">
                Es-tu plus orienté front-end ou back-end ?
                <svg class="hs-accordion-active:hidden block size-3.5" xmlns="http://www.w3.org/2000/svg" width="24"
                  height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                  stroke-linecap="round" stroke-linejoin="round">
                  <path d="M5 12h14"></path>
              ...
              <div id="hs-basic-active-bordered-collapse-one"
                ...
                <div class="pb-4 px-5">
                  <p class="text-gray-800 dark:text-neutral-400 leading-snug">
                    Je maîtrise les deux, mais j’ai une forte passion pour créer des interfaces utilisateurs accessibles
                    et performantes, donc je m'oriente davantage vers le front-end.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <button
                class="hs-accordion-toggle hs-accordion-active:text-blue-600 inline-flex justify-between items-center gap-x-3 w-full font-semibold text-start text-gray-900 py-4 px-5 hover:text-gray-900 disabled:opacity-50 disabled:pointer-events-none dark:hs-accordion-active:text-blue-500 dark:text-white dark:hover:text-neutral-400 dark:focus:outline-hidden dark:focus:text-neutral-400"
                aria-expanded="false" aria-controls="hs-basic-active-bordered-collapse-three">
                Quelles sont tes passions en dehors du développement ?
                <svg class="hs-accordion-active:hidden block size-3.5" xmlns="http://www.w3.org/2000/svg" width="24"
                  height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                  stroke-linecap="round" stroke-linejoin="round">
                  <path d="M5 12h14"></path>
              ...
              <div id="hs-basic-active-bordered-collapse-three"
                ...
                <div class="pb-4 px-5">
                  <p class="text-gray-800 dark:text-neutral-400 leading-snug">
                    En dehors du développement, je m’intéresse beaucoup à la psychologie et j’aime me plonger dans des
                    documentaires pour me cultiver. Je suis également passionné de graphisme et de football.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div id="hs-basic-active-bordered-collapse-three"
                ...
                <div class="pb-4 px-5">
                  <p class="text-gray-800 dark:text-neutral-400 leading-snug">
                    Cette année, j’essaie d’élargir mon champ de compétences au-delà du développement pur. Je
                    m’intéresse particulièrement au DevOps, pour mieux comprendre le déploiement, l’intégration continue
                    et l’automatisation des environnements. En parallèle, je découvre aussi les notions de base des LLM
                    (Large Language Models) dans l’intelligence artificielle. Enfin, je me forme au test automatisé avec
                    UiPath, afin de renforcer la qualité et la fiabilité des projets sur lesquels je travaille.
                  </p>
                </div>
              </div>
            </div>
