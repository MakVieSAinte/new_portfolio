  ...
  <div>
    ...
    <div class="mt-10 sm:mt-12">
      ...
      <p class="text-md font-light text-gray-800 dark:text-neutral-400">
        Mes projets sont le reflet de ma passion pour le design et l’ingénierie. Chaque réalisation est pensée pour allier esthétique, performance et expérience utilisateur.
      </p>
