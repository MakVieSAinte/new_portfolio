  ...
  <div role="main" aria-label="Hero section with profile information">
    ...
    <div class="flex items-center gap-x-3">
      <div class="shrink-0 border border-gray-300 dark:border-neutral-800 rounded-full p-[2.5px] overflow-hidden">
        <img class="shrink-0 size-24 rounded-full object-cover object-center transition-all duration-1000" :class="[
          isLoaded
            ? 'blur-0 scale-100 opacity-100'
            : 'blur-4xl scale-150 opacity-0',
        ]" src="/public/images/others/profil.jpg" alt="MakVieSAinte profile picture" width="96" height="96"
          loading="lazy" decoding="async" @load="isLoaded = true" />
      </div>

      <div class="grow ml-1 transition-all duration-1000"
    ...
    <section class="mt-8 mb-12" aria-labelledby="about-intro">
      <p id="about-intro" class="inline-block text-lg text-gray-800 dark:text-neutral-400 font-light" :class="[
        isLoaded
          ? 'blur-0 scale-100 opacity-100'
        ...
        <a href="https://www.linkedin.com/in/viesainte-mak" target="_blank" rel="noopener noreferrer"
          aria-label="Visit my LinkedIn profile" title="Connect with me on LinkedIn"
          ...
          <span
            ...
            <span class="group-hover:underline underline-offset-2 transition-all duration-200">LinkedIn</span>
          </span>
        </a>

        {{ texts?.hero?.description2 }}
        <a :href="cvLink" :download="cvFilename" aria-label="Download my CV" title="Download my curriculum vitae"
          ...
          <span
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor"
              class="bi bi-file-earmark-text-fill" viewBox="0 0 16 16" aria-hidden="true">
              <path
                d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0M9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1M4.5 9a.5.5 0 0 1 0-1h7a.5.5 0 0 1 0 1zM4 10.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5m.5 2.5a.5.5 0 0 1 0-1h4a.5.5 0 0 1 0 1z" />
            </svg>
            <span class="group-hover:underline underline-offset-2 transition-all duration-200 ps-1">
              <a :href="cvLink" :download="cvFilename" target="_blank" rel="noopener noreferrer">
      ...
      <div class="flex items-center flex-wrap gap-6 my-4">
        <div role="status" aria-live="polite" aria-label="Availability status: Open to opportunities"
          ...
          <span class="pulse block w-2 h-2 bg-primary rounded-full border-1 border-green-200" aria-hidden="true"></span>
