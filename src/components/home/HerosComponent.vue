<template>
  <div>
    ...
    <!-- Je suis un développeur passionné par la création d'interfaces utilisateur accessibles et parfaitement optimisées, alliant design soigné et ingénierie robuste. -->

    <!-- About -->
    <div class="mt-8 mb-12">
      <p class="inline-block text-lg text-gray-800 dark:text-neutral-400 font-light">
        Je suis un développeur passionné par la création d'interfaces utilisateur accessibles et parfaitement optimisées, alliant design soigné et ingénierie front-end et backend robuste.



    je m’efforce de créer des expériences à la fois esthétiques, intuitives et performantes et

<!-- <br> -->
         je partage régulièrement mes découvertes et projets sur

         <a href="linkedin" class="inline-block group bg-slate-100/50 dark:bg-neutral-800 px-3 py-[6px] rounded-[3px] hover:bg-slate-100/50 dark:hover:bg-neutral-700/50 border-neutral-300 dark:border-neutral-700  transition-all duration-500">
          ...
          </svg> <span class="group-hover:underline underline-offset-2 transition-all duration-200">LinkedIn</span>
          </span>
          </a>
...
</svg> <span class="group-hover:underline underline-offset-2 transition-all duration-200"> téléchargez CV</span>
          </span>
          </a>
