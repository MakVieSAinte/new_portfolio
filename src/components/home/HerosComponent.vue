  ...
  <div role="main" aria-label="Hero section with profile information">
    ...
    <section class="mt-8 mb-12" aria-labelledby="about-intro">
      <p id="about-intro" class="inline-block text-lg text-gray-800 dark:text-neutral-400 font-light"
        :class="[isLoaded ? 'blur-0 scale-100 opacity-100' : 'blur-4xl scale-110 opacity-0']">
        {{ texts?.hero?.description }}

        <a href="https://linkedin.com/in/MakVieSAinte" target="_blank" rel="noopener noreferrer"
        ...
        <a href="#download-cv" aria-label="Download my CV" title="Download my curriculum vitae"
