  ...
  <div>
    ...
    <div class="mt-8 mb-12">
      <p class="inline-block text-lg text-gray-800 dark:text-neutral-400 font-light">
        ...
        <a href="linkedin"
          class="inline-block group bg-slate-100/50 dark:bg-neutral-800 px-3 py-[6px] rounded-[3px] hover:bg-slate-100/50 dark:hover:bg-neutral-700/50 border-neutral-200/30 dark:border-neutral-700 transition-all duration-150">
          <span
      ...
      <div class="flex items-center flex-wrap gap-6 my-4">
        <div
          ...
          <span
            class="text-sm text-gray-800 font-normal dark:text-primary">{{ texts?.hero?.availableForOpportunities }}</span>
        </div>
      </div>
    </div>
  </div>
