<template>
  <div>
    ...
    <div class="flex items-center gap-x-3">
      ...
      <div class="grow ml-1">
        <h1
          class="text-4xl font-medium text-gray-800 dark:text-neutral-200 font-familjen_grotesk"
        >
          MakVieSAinte
        </h1>
        <p
          class="text-writter relative text-md font-light text-gray-900 dark:text-neutral-400 mt-[2px]"
        >
    ...
    <div class="mt-8 mb-12">
      ...
      >
        ...
        utilisateur accessibles et parfaitement optimisées, alliant design
        soigné et ingénierie front-end et backend robuste. je m’efforce de créer
        des expériences à la fois esthétiques, intuitives et performantes et
      ...
      <div class="flex items-center flex-wrap gap-6 my-4">
        ...
        >
          ...
          <span class="text-sm text-gray-800 font-normal dark:text-primary"
            >Disponible pour de nouvelles opportunités</span
          >
        </div>
      </div>
    </div>
