    ...
    <div class="flex flex-col md:flex-row md:items-start gap-6">
      ...
      <div class="flex-1">
        ...
        >
          ...
          <a
            :href="texts?.pageAbout?.achievement?.osiane_url"
            target="_blank"
          ...
          <a
            :href="texts?.pageAbout?.achievement?.kokamba_url"
            target="_blank"
            rel="noopener noreferrer"
            class="font-normal text-gray-800 dark:text-neutral-200 hover:text-primary dark:hover:text-primary transition-colors decoration-2 underline"
          >
        ...
        <div class="flex flex-wrap gap-3 mt-10">
          ...
          <a
            href="https://user-badge.committers.top/congo_brazzaville/MakVieSAinte"
            target="_blank"
            rel="noopener noreferrer"
            title="Top Committers Badge"
            class="hover:opacity-80 transition-opacity"
          >
            <img
              src="https://user-badge.committers.top/congo_brazzaville_public/MakVieSAinte.svg"
          ...
          <!-- Wakatime Badge -->
          <a
            href="https://wakatime.com/@b2ac3fad-13f4-43d8-8744-9e52d15163fe"
            target="_blank"
            rel="noopener noreferrer"
          ...
          >
            <img
              src="https://wakatime.com/badge/user/b2ac3fad-13f4-43d8-8744-9e52d15163fe.svg"
              alt="wakatime"
              class="h-auto"
            />
          </a>
