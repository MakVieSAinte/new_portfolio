<template>
  <div
    class="box-main mx-auto pt-32 pb-10 px-8 lg:px-12 md:px-8 sm:px-5 border bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-800"
  >
    <router-link
    ...
    try {
      ...
      if (post) {
        post.content.html = post.content.html
          ...
          .replace(
            /<pre(?=\s*><code)/g,
            '<pre class="mt-8 code-paragraph mb-8"',
          )
