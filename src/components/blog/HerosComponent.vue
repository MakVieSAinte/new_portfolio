      ...
      <p class="inline-block text-lg text-gray-800 dark:text-neutral-400 font-light">
        ...
        <a href="https://github.com/MakVieSAinte"
          ...
          <span
            ...
            <svg fill="currentColor" width="17" height="17"
            ...
            <span class="group-hover:underline underline-offset-2 transition-all duration-200">{{ texts?.pageBlog?.plateforme }}</span>
          </span>
        </a>
